...
Partial Class FormFlight
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label25.Text = "Расстояние между городами(м)"
        '
        'Label24
        '
        ...
        Me.Label12.Text = "Код города второй посадки"
        '
        'Label11
        '
        ...
        Me.Label10.Text = "Время первой посадки"
        '
        'Label9
        '
        ...
        Me.Label9.Text = "Код города первой посадки"
        '
        'Label8
        '
        ...
        Me.Label7.Text = "Код города вылета"
        '
        'Label6
        '
        ...
        Me.Label6.Text = "Дни выполнения рейса"
        '
        'Label5
        '
        ...
        Me.Label3.Text = "Код авиакомпании"
        '
        'Label2
        '
